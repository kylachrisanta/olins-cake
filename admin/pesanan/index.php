...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 25px;">
            <h1 class="page-title" style="margin-bottom:0;">Data Pesanan</h1>
        </div>
        ...
        <div style="background:white; padding:50px; border-radius:10px; box-shadow:0 5px 15px rgba(0,0,0,0.05); text-align:center;">
            ...
            <p style="color: #94a3b8; line-height:1.6;">Halaman manajemen pesanan sudah disiapkan templatenya.<br>Anda dapat melanjutkannya nanti sesuai dengan struktur tabel database Anda.</p>
        </div>
    </div>
</div>
